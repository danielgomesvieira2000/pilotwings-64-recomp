...
no loaded module::
    ...
    [pw64] recomp::start returned -- runtime shut down
    [pw64] shutting down: controller
    [pw64] shutting down: window
    [pw64] ==== CRASH ====
    [pw64] ACCESS_VIOLATION (0xC0000005) at 0000019704441630
    [pw64] while executing address 0x19704441630
...
MARKER = "pw64: the SDL event filter has to come back off"
...
REPLACEMENT = """    ApplicationWindow::~ApplicationWindow() {
        ...
        // Added by the Pilotwings 64 port -- %s.
