...
Like the other large patches this is a diff rather than anchored strings --
...
from patchlib import apply_patch
...
# line endings in patchlib.py. join_timer_thread is declared by this
