...
// specific to Pilotwings 64: a first-run flow that asks the player for their own
...
//
// It is compiled only when PW64_WITH_FRONTEND is on. Without it the port keeps
// the phase 03 behaviour of taking a ROM path on the command line, which is
// what scripted verification runs use.
